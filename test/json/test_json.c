...
static void free_object(gain_object* object)
{
...
static void should_be_null_gain_object(gain_object* object)
{
...
void test_json_should_return_null_when_bad_json_string(void)
{
    ...
    gain_object* object = json_parse_gain_object(json);
    should_be_null_gain_object(object);
    free_object(object);
}
...
void test_json_should_return_null_when_string_begins_with_array_and_is_not_json_string(void)
{
    char* json = "{\"objects\":[{}]}";
    gain_object* object = json_parse_gain_object(json);
    should_be_null_gain_object(object);
