...
private:
        ...
        std::size_t bytes_transferred)
    {
        ...
        std::string str =
            static_cast<std::string>("{\"objects\":[{\"id\":\"Urms\",\"value\":230},") +
            static_cast<std::string>("{\"id\":\"Pmean\",\"value\":10},") +
            static_cast<std::string>("{\"id\":\"Pmean2\",\"value\":20}]}");

        char *data = const_cast<char*>(str.c_str());

        net::mutable_buffer buffers ( data, str.length() );
